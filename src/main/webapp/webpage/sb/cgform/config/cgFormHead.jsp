...
<%@page import="com.sbplatform.web.cgform.common.CgAutoListConstant"%>
		...
		<tr>
			...
			<td class="value" colspan="3">
			  <input class="inputxt" id="tableName" name="tableName" value="${cgFormHeadPage.tableName}"
				prefixName="" <c:if test="${not empty cgFormHeadPage.tableName}">readonly="readonly"</c:if> datatype="*" validType="cgform_t_head,table_Name,id" nullmsg="请输入表名！"> 
