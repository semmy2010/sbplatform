...
<t:formvalid formid="formobj" layout="div" dialog="true" action="demoController.do?saveDemo">
	...
	<div class="form"><label class="Validform_label"> 上级DEMO： </label> <t:comboTree url="demoController.do?pDemoList" name="parent.id" id="pdemo" value="${demo.parent.id }"></t:comboTree></div>
