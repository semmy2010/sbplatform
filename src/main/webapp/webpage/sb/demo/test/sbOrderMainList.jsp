...
<div region="center" style="padding: 1px;"><t:datagrid name="sbOrderMainList" title="订单信息" actionUrl="sbOrderMainController.do?datagrid" idField="id" fit="true">
	...
	<t:dgDelOpt title="删除" url="sbOrderMainController.do?del&id={id}" />
	<t:dgToolBar title="录入" icon="icon-add" url="sbOrderMainController.do?addorupdate" funname="add" width="1000" height="400"></t:dgToolBar>
	<t:dgToolBar title="编辑" icon="icon-edit" url="sbOrderMainController.do?addorupdate" funname="update" width="1000" height="400"></t:dgToolBar>
</t:datagrid></div>
</div>
