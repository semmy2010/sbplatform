...
<script type="text/javascript">
	...
	$('#addCustomBtn').bind('click', function(){   
 		 var tr =  $("#add_sbStudent_table_template tr").clone();
	 	 $("#add_sbStudent_table").append(tr);
	 	 resetTrNum('add_sbStudent_table');
    });  
	$('#delCustomBtn').bind('click', function(){   
      	$("#add_sbStudent_table").find("input:checked").parent().parent().remove();   
        resetTrNum('add_sbStudent_table'); 
    }); 
