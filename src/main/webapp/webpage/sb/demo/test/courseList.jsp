...
<script type="text/javascript" charset="utf-8">
	...
	function courseListExportXls() {
		SbExcelExport("courseController.do?exportXls","courseList");
	}
	function courseListExportXlsByT() {
		SbExcelExport("courseController.do?exportXlsByT","courseList");
	}
	function courseListExportXlsByTe() {
		SbExcelExport("courseController.do?exportXlsByTest","courseList");
	}
