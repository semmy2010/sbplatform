...
<div region="center" style="padding: 1px;"><t:datagrid name="sbNoteList" title="单表模型" actionUrl="sbNoteController.do?datagrid" idField="id" fit="true" queryMode="group">
	...
	<t:dgDelOpt title="删除" url="sbNoteController.do?del&id={id}" />
	<t:dgToolBar title="录入" icon="icon-add" url="sbNoteController.do?addorupdate" funname="add" operationCode="add"></t:dgToolBar>
	<t:dgToolBar title="编辑" icon="icon-edit" url="sbNoteController.do?addorupdate" funname="update"></t:dgToolBar>
</t:datagrid></div>
</div>