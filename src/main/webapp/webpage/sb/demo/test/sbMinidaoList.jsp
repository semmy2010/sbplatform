...
<t:datagrid name="sbMinidaoList" title="Minidao例子" actionUrl="sbMinidaoController.do?datagrid" idField="id" fit="true" queryMode="group">
	...
	<t:dgDelOpt title="删除" url="sbMinidaoController.do?del&id={id}" />
	<t:dgToolBar title="录入" icon="icon-add" url="sbMinidaoController.do?addorupdate" funname="add"></t:dgToolBar>
	<t:dgToolBar title="编辑" icon="icon-edit" url="sbMinidaoController.do?addorupdate" funname="update"></t:dgToolBar>
	<t:dgToolBar title="查看" icon="icon-search" url="sbMinidaoController.do?addorupdate" funname="detail"></t:dgToolBar>
</t:datagrid>
</div>
</div>