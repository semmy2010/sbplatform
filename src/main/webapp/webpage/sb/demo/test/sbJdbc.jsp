...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="sbJdbcController.do?save">
	<input id="id" name="id" type="hidden" value="${sbJdbcPage.id }">
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value"><input class="inputxt" id="depId" name="depId" ignore="ignore" value="${sbJdbcPage.depId}"> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="value"><input class="inputxt" id="sex" name="sex" ignore="ignore" value="${sbJdbcPage.sex}"> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
