...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="sbDemoController.do?saveAuthor">
	<input id="id" name="id" type="hidden" value="${sbDemo.id }">
