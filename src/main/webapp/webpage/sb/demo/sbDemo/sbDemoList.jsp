...
<t:datagrid name="sbDemoList" title="DEMO示例列表" autoLoadData="true" actionUrl="sbDemoController.do?datagrid" sortName="userName" fitColumns="true"
	...
	<t:dgDelOpt operationCode="del" title="删除" url="sbDemoController.do?del&id={id}" />
	<t:dgToolBar operationCode="add" title="录入" icon="icon-add" url="sbDemoController.do?addorupdate" funname="add"></t:dgToolBar>
	<t:dgToolBar operationCode="edit" title="编辑" icon="icon-edit" url="sbDemoController.do?addorupdate" funname="update"></t:dgToolBar>
	<t:dgToolBar operationCode="detail" title="查看" icon="icon-search" url="sbDemoController.do?addorupdate" funname="detail"></t:dgToolBar>
	<t:dgToolBar operationCode="print" title="打印" icon="icon-print" url="sbDemoController.do?print" funname="detail"></t:dgToolBar>
	<t:dgToolBar title="批量删除" icon="icon-remove" url="sbDemoController.do?doDeleteALLSelect" funname="deleteALLSelect"></t:dgToolBar>
...
<script type="text/javascript">
	function szqm(id) {
		createwindow('审核', 'sbDemoController.do?doCheck&id=' + id);
	}
	function getListSelections(){
		var ids = '';
		var rows = $("#sbDemoList").datagrid("getSelections");
	...
	function doMigrateIn(){
		openuploadwin('Xml导入', 'transdata.do?toMigrate', "sbDemoList");
	}
