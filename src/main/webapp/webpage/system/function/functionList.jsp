...
<div region="center" style="padding: 1px;"><t:datagrid name="functionList" title="菜单管理" actionUrl="functionController.do?functionGrid" idField="id" treegrid="true" pagination="false">
	...
	<t:dgCol title="菜单名称" field="name" treefield="text"></t:dgCol>
	<t:dgCol title="图标" field="icon_iconPath" treefield="code" image="true"></t:dgCol>
	<t:dgCol title="菜单地址" field="url" treefield="src"></t:dgCol>
	<t:dgCol title="菜单顺序" field="sort" treefield="order"></t:dgCol>
