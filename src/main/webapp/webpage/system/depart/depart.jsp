...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveDepart">
	...
	<fieldset class="step">
	<div class="form"><label class="Validform_label"> 部门名称: </label> <input name="name" class="inputxt" value="${depart.name }" validType="s_t_department,name,id" datatype="s3-10">
	...
	<div class="form"><label class="Validform_label"> 上级部门: </label> <input id="cc" name="depart.id" value="${depart.parent.name}"></div>
	</fieldset>
</t:formvalid>
</body>
</html>
