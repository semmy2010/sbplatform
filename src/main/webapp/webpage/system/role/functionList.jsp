...
<body>
<t:datagrid name="functionList" title="权限管理" actionUrl="roleController.do?setOperate&roleId=${roleId}" idField="id" treegrid="true" pagination="false">
	<t:dgCol title="编号" field="id" treefield="id" hidden="true"></t:dgCol>
	<t:dgCol title="权限名称" field="name" width="100" treefield="text"></t:dgCol>
