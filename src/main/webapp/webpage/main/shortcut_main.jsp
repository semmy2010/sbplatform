...
<html>
<head>
<title>SB 微云快速开发平台</title>
<t:base type="jquery,easyui,tools,DatePicker,autocomplete"></t:base>
<!-- 
<link rel="stylesheet" href="plug-in/sb/css/main.css" type="text/css"></link>
 -->
...
<SCRIPT type="text/javascript">
	$(function() {
				...
				.datagrid(
						{
							...
							onLoadSuccess : function(data) {
								$('#layout_sb_onlinePanel').panel('setTitle',
										'( ' + data.total + ' )人在线');
							}
		...
		$('#layout_sb_onlinePanel').panel({
			tools : [ {
				iconCls : 'icon-reload',
				handler : function() {
					$('#layout_sb_onlineDatagrid').datagrid('load', {});
				}
			} ]
		});
				...
				.click(
						function() {
							...
							$('#layout_east_calendar').parent().css("width",
									"auto");
							$("#layout_sb_onlinePanel").find(".datagrid-view")
									.css("max-height", "200px");
							$(
									"#layout_sb_onlinePanel .datagrid-view .datagrid-view2 .datagrid-body")
...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	...
	<div region="north" border="false" title="" style="BACKGROUND: #A8D7E9; height: 105px; padding: 1px; overflow: hidden;">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="left" style="vertical-align: text-bottom"><img src="plug-in/login/images/logo.jpg"> </td>
							...
							<td style="" colspan="2">
								<div style="background: url(plug-in/login/images/top_bg.jpg) no-repeat right center; float: right;">
									<div style="float: left; line-height: 25px; margin-left: 70px;">
										<span style="color: #386780">当前用户:</span> <span style="color: #FFFFFF">${userName }</span>&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: #386780">职务:</span>
										<span style="color: #FFFFFF">${roleName }</span>
									</div>
									<div style="float: left; margin-left: 18px;">
										<div style="right: 0px; bottom: 0px;">
											<a href="javascript:void(0);" class="easyui-menubutton" menu="#layout_north_kzmbMenu" iconCls="icon-comturn">控制面板</a>&nbsp;&nbsp;
											<a href="javascript:void(0);" onclick="exit('loginController.do?logout','确定退出该系统吗 ?',1);" class="easyui-linkbutton" plain="true" iconCls="icon-exit">退出系统</a>
										</div>
	...
	<div collapsed="true" region="east" iconCls="icon-reload" title="辅助工具" split="true" style="width: 190px;"
		...
		<div id="layout_sb_onlinePanel" data-options="fit:true,border:false" title="用户在线列表">
			<table id="layout_sb_onlineDatagrid"></table>
		</div>
	</div>
	<!-- 底部 -->
	<div region="south" border="false" style="height: 25px; overflow: hidden;">
		<div align="center" style="color: #1fa3e5; padding-top: 2px">
			&copy; 版权所有 <span class="tip"><a href="http://www.sb.org" title="SB Framework 1.0.0 SNAPSHOT版本">SB Framework 1.0.0 SNAPSHOT</a> (推荐谷歌浏览器，获得更快响应速度)
				技术支持:<a href="#" title="SB Framework 1.0.0 SNAPSHOT版本">SB Framework 1.0.0 SNAPSHOT</a> </span>
		</div>
	</div>
