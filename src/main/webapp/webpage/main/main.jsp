...
<SCRIPT type="text/javascript">
	...
	$(function() {
		$('#layout_sb_onlineDatagrid').datagrid({
			...
			onLoadSuccess : function(data) {
				$('#layout_sb_onlinePanel').panel('setTitle', '( ' + data.total + ' )人在线');
			},
		...
		$(".layout-expand").click(function(){
			...
			$("#layout_sb_onlinePanel").find(".datagrid-view").css("max-height","200px");
			$("#layout_sb_onlinePanel .datagrid-view .datagrid-view2 .datagrid-body").css("max-height","180px").css("overflow-y","auto");
		});
	});
	var onlineInterval;
...
<!-- 顶部-->
<div region="north" border="false" title=" SB Framework 1.0.0 SNAPSHOT" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
...
<div align="center" style="color: #CC99FF; padding-top: 2px">&copy; 版权所有 <span class="tip"><a href="http://www.sb.org" title=" SB Framework 1.0.0 SNAPSHOT"> SB Framework 1.0.0 SNAPSHOT</a> (推荐谷歌浏览器，获得更快响应速度) 技术支持:<a href="#" title=" SB Framework 1.0.0 SNAPSHOT">SB Framework 1.0.0 SNAPSHOT</a> </span></div>
</div>
