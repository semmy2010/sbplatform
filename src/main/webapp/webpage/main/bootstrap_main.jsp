...
<div class="container-fluid"><a class="brand" href="http://www.sb.org" target="_blank">SB 演示系统 &nbsp;&nbsp;<span class="slogan"></span></a>
...
<ul class="footer-links">
	<li style="display: inline;">&copy; 版权所有<a href="http://www.sb.org" title="SB Framework 1.0.0 SNAPSHOT">SB Framework 1.0.0 SNAPSHOT</a></li>
	<li style="display: inline;">&nbsp;(推荐谷歌浏览器，获得更快响应速度) 技术支持:<a title="SB Framework 1.0.0 SNAPSHOT版本" href="http://www.sb.org">SB Framework 1.0.0 SNAPSHOT</a></li>
</ul>
</div>
</footer>
