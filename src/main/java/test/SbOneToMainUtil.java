...
import com.sbplatform.codegenerate.generate.onetomany.CodeGenerateOneToMany;
...
public class SbOneToMainUtil {
	...
	public static void main(String[] args) {
		...
		codeParamEntityIn.setTableName("sb_order_main");//主表[表名]
		codeParamEntityIn.setEntityName("OrderMain");	 //主表[实体名]
		codeParamEntityIn.setEntityPackage("sb");	 //主表[包名]
		...
		po.setTableName("sb_order_custom");//子表[表名]
		po.setEntityName("OrderCustoms");	 //子表[实体名]
		po.setEntityPackage("sb");			 //子表[包]
		...
		po2.setTableName("sb_order_product");		//子表[表名]
		po2.setEntityName("OrderProduct");			//子表[实体名]
		po2.setEntityPackage("sb"); 					//子表[包]
