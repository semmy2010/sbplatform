...
import com.sbplatform.poi.excel.ExcelExportOfTemplateUtil;
import com.sbplatform.poi.excel.ExcelExportUtil;
import com.sbplatform.poi.excel.ExcelImportUtil;
import com.sbplatform.poi.excel.ExcelUtil;
import com.sbplatform.poi.excel.entity.ExcelTitle;
import com.sbplatform.poi.excel.entity.ImportParams;
import com.sbplatform.poi.excel.entity.TemplateExportParams;
import com.sbplatform.tag.core.easyui.TagUtil;
import com.sbplatform.web.demo.entity.test.CourseEntity;
import com.sbplatform.web.demo.entity.test.JpPersonEntity;
...
public class CourseController extends BaseController {
	...
	public ModelAndView course(HttpServletRequest request) {
		return new ModelAndView("sb/demo/test/courseList");
	}
	...
	public void datagrid(CourseEntity course,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		com.sbplatform.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, course, request.getParameterMap());
	...
	public ModelAndView addorupdate(CourseEntity course, HttpServletRequest req) {
		...
		return new ModelAndView("sb/demo/test/course");
	}
	/**
	 * 学生列表
	 * 
	...
	public ModelAndView studentsList(CourseEntity course, HttpServletRequest req) {
		...
		return new ModelAndView("sb/demo/test/CourseStudentList");
	}
	/**
	 * 学生列表
	 * 
	...
	public ModelAndView upload(HttpServletRequest req) {
		return new ModelAndView("sb/demo/test/courseUpload");
	}
	...
	public void exportXls(CourseEntity course,HttpServletRequest request,HttpServletResponse response
		...
		try {
			...
			workbook = ExcelExportUtil.exportExcel(new ExcelTitle("课程列表", "导出人:Sb",
