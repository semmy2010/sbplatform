package com.sbplatform.web.cgform.service.impl.config;
...
import com.sbplatform.web.cgform.dao.config.CgFormFieldDao;
...
import com.sbplatform.web.cgform.entity.config.CgSubTableVO;
...
import com.sbplatform.web.cgform.service.impl.config.util.DbTableProcess;
...
public class CgFormFieldServiceImpl extends CommonServiceImpl implements
	...
	public List<Map<String, Object>> getSubTableData(String mainTableName,
		...
		sql1.append("select f.* from cgform_t_field f ,cgform_t_head h");
