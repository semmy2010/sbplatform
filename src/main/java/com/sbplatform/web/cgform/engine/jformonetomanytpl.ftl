				...
				<tr>
					...
					<#elseif subTableField.show_type=='radio'>
				        <@DictData name="${subTableField.dict_field?if_exists?html}" tablename="${subTableField.dict_table?if_exists?html}" var="dataList">
							...
							<input value="${dictdata.code?if_exists?html}" name="${sub}[#index#].${subTableField.field_name}" type="radio">
					...
					<#elseif subTableField.show_type=='checkbox'>
						<@DictData name="${subTableField.dict_field?if_exists?html}" tablename="${subTableField.dict_table?if_exists?html}" var="dataList">
							<#list dataList as dictdata> 
							<input value="${dictdata.code?if_exists?html}" name="${sub}[#index#].${subTableField.field_name}" type="checkbox">
								${dictdata.name?if_exists?html}
							</#list> 
						</@DictData>
