...
<html>
 ...
 <body>
  <form id="formobj" action="cgFormBuildController.do?saveOrUpdateMore" name="formobj" method="post"><input type="hidden" id="btn_sub" class="btn_sub"/>
	<#include "com/sbplatform/web/cgform/engine/jformhead.ftl">
  ...
  function uploadFile(data){
	...
	function del(url,obj){
			...
			<div style="width: auto;height: 200px;">
				...
				<#list subtablelist as sub >
				    <#if field['${sub}']?exists >
					    ...
					    <#include "com/sbplatform/web/cgform/engine/jformonetoone.ftl">
					    <#else>
					    <#include "com/sbplatform/web/cgform/engine/jformonetomany.ftl">
					    </#if>
					</#if>
				</#list>
				</div>
		...
		<#list subtablelist as sub >
		    <#if field['${sub}']?exists >
				<#if field['${sub}'].head.relationType!=1 >
			    <#include "com/sbplatform/web/cgform/engine/jformonetomanytpl.ftl">
			    </#if>
			</#if>
		</#list>
		</table>
