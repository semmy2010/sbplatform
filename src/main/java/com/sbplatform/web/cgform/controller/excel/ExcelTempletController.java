package com.sbplatform.web.cgform.controller.excel;
...
import com.sbplatform.web.cgform.service.excel.ExcelTempletService;
...
public class ExcelTempletController extends BaseController {
	...
	public ModelAndView goImplXls(HttpServletRequest request) {
		...
		return new ModelAndView("sb/cgform/excel/upload");
	}
