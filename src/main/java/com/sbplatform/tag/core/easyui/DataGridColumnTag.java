...
public class DataGridColumnTag extends TagSupport {
	...
	protected boolean hidden = false;//默认显示表格字段
	...
	public int doEndTag() throws JspTagException {
		...
		parent.setColumn(title, field, width, rowspan, colspan, align, sortable, checkbox, formatter, hidden, replace, treefield, image, imageSize, query, url, funname, arg, queryMode,
				dictionary, frozenColumn, extend, style, downloadName, autocomplete, extendParams);
		return EVAL_PAGE;
	}
