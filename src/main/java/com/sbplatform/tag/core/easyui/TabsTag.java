...
import com.sbplatform.tag.vo.easyui.Tab;
...
public class TabsTag extends TagSupport {
	...
	public StringBuffer end() {
		...
		if (iframe) {
			...
			sb.append("{");
			sb.append("var s = \'<iframe id=\"\'+id+\'\" scrolling=\"no\" frameborder=\"0\"  src=\"about:sb\" width=\""+oConvertUtils.getString(width, "100%")+"\" height=\""+oConvertUtils.getString(heigth, "99.5%")+"\"></iframe>\';");
			sb.append("return s;");
			sb.append("}");
			sb.append("});");
			sb.append("</script>");
