package com.sbplatform.codegenerate.window;
	...
	public CodeWindow() {
		...
		confirmbtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					boolean tableexist = new SbReadTable().checkTableExist(CodeWindow.tableName);
					if (tableexist) {
						new CodeGenerate(CodeWindow.entityPackage, CodeWindow.entityName, CodeWindow.tableName, CodeWindow.ftlDescription, createFileProperty, CodeWindow.fieldRowNum,
