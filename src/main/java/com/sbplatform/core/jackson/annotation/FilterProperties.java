package com.sbplatform.core.jackson.annotation;
...
public @interface FilterProperties {
     ...
     * @return
     */
    IgnoreProperty[] ignore() default @IgnoreProperty(clazz = Object.class, property = "");
     ...
     * @return
     */
    AllowProperty[] allow() default @AllowProperty(clazz = Object.class, property = "");
}
