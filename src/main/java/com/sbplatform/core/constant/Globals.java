package com.sbplatform.core.constant;
...
public final class Globals {
	...
	public static Short Log_Leavel_ERROR=3;
	 ...
	 static{
		 String button_authority_sb = ResourceUtil.getSessionattachmenttitle("button.authority.sb");
		 if("true".equals(button_authority_sb)){
