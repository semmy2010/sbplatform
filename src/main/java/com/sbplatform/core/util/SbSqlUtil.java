...
import com.sbplatform.core.def.ConstantsDefs;
...
public class SbSqlUtil {
	...
	private static String getFlieTxt(String fileUrl) {
		com.sbplatform.core.util.LogUtil.info("---------------------------------------sql 路径 :"+fileUrl);
		String sql = null;
		try {
	...
	public static String getMethodSqlLogic(String methodUrl){
		...
		String projectPath = getAppPath(SbSqlUtil.class);
		sqlurl = projectPath + SUFFIX_X+sqlurl;
		com.sbplatform.core.util.LogUtil.info(sqlurl);
...
//		返回读取指定资源的输入流   
        InputStream is = SbSqlUtil.class.getResourceAsStream(sqlurl);    
...
//		com.sbplatform.core.util.LogUtil.info(projectPath);
//		String projectPath =  request.getSession().getServletContext().getRealPath("/");
	...
	public static String getAppPath(Class cls) {
		...
		com.sbplatform.core.util.LogUtil.info("realPath----->"+realPath);
		return realPath;
	}
	...
	public static void main(String[] args) {
		//com.sbplatform.core.util.LogUtil.info(getAppPath(SbSqlUtil.class));
		com.sbplatform.core.util.LogUtil.info(getCountSqlBySql("SELECT * 	from SB_DICT_PARAM WHERE 1=1"));
	}
